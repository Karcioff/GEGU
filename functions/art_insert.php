...
$docs = filter_var($_POST['art_docs'], FILTER_SANITIZE_STRING);

$sql = "INSERT INTO articoli (ART_AUTORE, ART_TITOLO, ART_TESTO, ART_DATA, ART_BRANCA,ART_ALLEGATO, ART_FOTO) "
        . "VALUES ('$autore','$titolo','$testo','$data','$branca','$docs','$foto')";
